...
* [Labels](#labels) for displaying time, defined by: 
  ...
  * [Time formats](#time-formats): default format strings with `chronon_format_linear()`, `chronon_format_cyclical()`, `chronon_format_duration()`
...
* `lin(<time granule>)` - Granule labels for linear time grnaules, usually the largest granule (e.g. `lin(year(1L))`). These labels are produced by `linear_labels()`.
