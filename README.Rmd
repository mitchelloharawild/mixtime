...
[![CRAN status](https://www.r-pkg.org/badges/version/mixtime)](https://CRAN.R-project.org/package=mixtime)
<!-- badges: end -->
...
**📈 Linear Time** - Create linear time vectors with `linear_time()` or with helpers:
  ...
  * `year()`, `yearquarter()`, `yearmonth()`, `yearweek()`, `date()`, `datetime()`
...
The mixtime package allows time of different granularities to be combined in a single vector.
