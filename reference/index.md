...
- [`year()`](linear_gregorian.md) [`yearquarter()`](linear_gregorian.md)
  [`yearmonth()`](linear_gregorian.md)
  [`yearmonthday()`](linear_gregorian.md) : Gregorian continuous time
  representations
...
- [`tz_name()`](tz_name.md) : Extract timezone from an object
- [`tz_offset()`](tz_offset.md) : Get timezone offset
- [`tz_abbreviation()`](tz_abbreviation.md) : Get timezone abbreviation
- [`tz_transitions()`](tz_transitions.md) : Get timezone transitions
...
- [`chronon_common()`](chronon_common.md) : Find a common chronon from a
  set of chronons
- [`mt_unit()`](mt_unit.md) [`mt_tz_unit()`](mt_unit.md) : Base S7 class
  for creating new time units
...
- [`seq(`*`<mt_cyclical>`*`)`](seq.mixtime.md)
  [`seq(`*`<mt_linear>`*`)`](seq.mixtime.md)
  [`seq(`*`<mixtime>`*`)`](seq.mixtime.md) : Generate sequences of
  mixtime values
