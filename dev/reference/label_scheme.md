...
[`cyclical_labels_format()`](https://pkg.mitchelloharawild.com/mixtime/dev/reference/label_format.md)'s
`type` argument.

## Irregular cycles

`at` (in `transform`'s `encode`/`decode`, and in
[`cyclical_labels_format()`](https://pkg.mitchelloharawild.com/mixtime/dev/reference/label_format.md)/[`cyclical_labels_parse()`](https://pkg.mitchelloharawild.com/mixtime/dev/reference/label_format.md))
...
[`linear_labels_format()`](https://pkg.mitchelloharawild.com/mixtime/dev/reference/label_format.md)'s
"Epoch shift" section).

The `...` on `_format()` is not just style:
[`format()`](https://rdrr.io/r/base/format.html) forwards whatever
[component_helpers](https://pkg.mitchelloharawild.com/mixtime/dev/reference/component_helpers.md)'
...
[`linear_labels_format()`](https://pkg.mitchelloharawild.com/mixtime/dev/reference/label_format.md)/[`cyclical_labels_format()`](https://pkg.mitchelloharawild.com/mixtime/dev/reference/label_format.md)
